...
CREATE INDEX idx_humidities_timestamp_brin ON humidities USING BRIN(datetime);
CREATE INDEX idx_humidities_timestamp ON humidities((extract(epoch from datetime at time zone 'UTC')));
CREATE INDEX idx_humidities_sensors ON humidities(sensor_id);
